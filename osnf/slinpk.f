      ...
      !> instrumented linpack routines used in timing comparisons (single precision)
      !>Downloaded from Netlib, 2019 
      subroutine sgefa(a,lda,n,ipvt,info)
      integer lda,n,ipvt(*),info ! pc - change from 1 to *
      real a(lda,*)              ! pc - change from 1 to *
c
...
c
   ...
   70 continue
      ...
      integer lda,n,ipvt(*),job ! pc - change from 1 to *
      real a(lda,*),b(*)        ! pc - change from 1 to *
c
...
c
      real sx(*),sy(*),sa ! pc - change from 1 to *
...
c     jack dongarra, linpack, 3/11/78.
c
      real sx(*),sy(*)  ! pc - change from 1 to *
      integer i,incx,incy,ix,iy,m,mp1,n
c
      if(n.le.0)return
      if(incx.eq.1.and.incy.eq.1)go to 20
...
c     jack dongarra, linpack, 3/11/78.
c
      real sa,sx(*) ! pc - change from 1 to *
...
c     jack dongarra, linpack, 3/11/78.
c
      real sx(*),smax  ! pc - change from 1 to *
      integer i,incx,ix,n
c
      isamax = 0
      if(n.lt.1) return
