...
c
   ...
   70 continue
      ...
      double precision a(lda,*),b(*) ! pc - change from 1 to *
c
...
c
      double precision dx(*),dy(*),da ! pc - change from 1 to *
...
c     jack dongarra, linpack, 3/11/78.
c
      double precision sx(*),sy(*)  ! pc - change from 1 to *
      integer i,incx,incy,ix,iy,m,mp1,n
c
      if(n.le.0)return
      if(incx.eq.1.and.incy.eq.1)go to 20
...
c     jack dongarra, linpack, 3/11/78.
c
      double precision da,dx(*) ! pc - change from 1 to *
...
c     jack dongarra, linpack, 3/11/78.
c
      double precision dx(*),dmax ! pc - change from 1 to *
      integer i,incx,ix,n
c
      idamax = 0
      if(n.lt.1) return
